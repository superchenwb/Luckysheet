...
const dependScripts = [
  'luckysheet/expendPlugins/download/exceljs.min.js',
  'luckysheet/expendPlugins/download/FileSaver.min.js',
  // 'expendPlugins/download/exceljs.min.js',
  // 'expendPlugins/download/FileSaver.min.js',
];
...
const setStyleAndValue = function(table, worksheet) {
...
async function onClickDownload() {
  ...
  window.saveAs(new Blob([buffer]), `${document.title}.xlsx`);
}

export { download, onClickDownload };
