...
import { onClickDownload } from '../expendPlugins/download/plugin';
import { onClickUpload } from '../expendPlugins/upload/plugin';
...
export default function luckysheetHandler() {
  ...
  $('#luckysheet-cell-main, #luckysheetTableContent')
    .mousedown(function(event) {
      ...
      $('#luckysheet-cell-selected')
        ...
        .css('cursor', 'default');
      $('#luckysheet-cell-main, #luckysheetTableContent, #luckysheet-sheettable_0').css(
        'cursor',
        'default',
      );
      ...
      if (
        ...
        mouse[0] <
          luckysheetFreezen.freezenverticaldata[0] - luckysheetFreezen.freezenverticaldata[2]
      ) {
      ...
      if (
        ...
        mouse[1] <
          luckysheetFreezen.freezenhorizontaldata[0] - luckysheetFreezen.freezenhorizontaldata[2]
      ) {
      ...
      if (parseInt($input.css('top')) > 0) {
        ...
        if (
          checkProtectionSelectLockedOrUnLockedCells(row_index, col_index, Store.currentSheetIndex)
        ) {
          Store.luckysheet_select_status = true;
        }
      }
    ...
    .mouseup(function(event) {
      if (event.which == '3') {
        ...
        if (
          ...
          $$('#luckysheet-del-selected').style.display = cellRightClickConfig.deleteColumn
            ? 'block'
            : 'none';
          $$('#luckysheet-hide-selected').style.display = cellRightClickConfig.hideColumn
            ? 'block'
            : 'none';
          $$('#luckysheet-show-selected').style.display = cellRightClickConfig.hideColumn
            ? 'block'
            : 'none';
          $$(
          ...
          $$('#luckysheet-bottom-right-add-selected').style.display = cellRightClickConfig.insertRow
            ? 'block'
            : 'none';
          $$('#luckysheet-del-selected').style.display = cellRightClickConfig.deleteRow
            ? 'block'
            : 'none';
          $$('#luckysheet-hide-selected').style.display = cellRightClickConfig.hideRow
            ? 'block'
            : 'none';
          $$('#luckysheet-show-selected').style.display = cellRightClickConfig.hideRow
            ? 'block'
            : 'none';
          ...
          if (
            ...
            $$('#luckysheet-cols-rows-handleincell .luckysheet-menuseparator').style.display =
              'none';
    ...
    if (formula.functionResizeStatus) {
      ...
      function mouseRender() {
        ...
        if (Store.luckysheet_select_status) {
          ...
          let winH =
              $(window).height() + scrollTop - Store.sheetBarHeight - Store.statisticBarHeight,
          ...
          if (row_s < 0 || y < 0) {
            row_s = 0;
            row_e =
              Store.luckysheet_select_save[0]['row'][1] - Store.luckysheet_select_save[0]['row'][0];
          }
        ...
        //image cropChange
          ...
          let imgSrc =
            typeof imageUrlHandle === 'function' ? imageUrlHandle(imgItem.src) : imgItem.src;
  ...
  $(document).on('mouseup.luckysheetEvent', function(event) {
    ...
    if (Store.luckysheet_rows_change_size) {
      ...
      $('#luckysheet-sheettable, #luckysheet-rows-h, #luckysheet-rows-h canvas').css(
        'cursor',
        'default',
      );
    ...
    if (Store.luckysheet_cols_change_size) {
      ...
      if (changeColumnSelected) {
        ...
        cfg['columnlen'][Store.luckysheet_cols_change_size_start[1]] = Math.ceil(
          size / Store.zoomRatio,
        );
      }
    ...
    if (Store.luckysheet_cell_selected_move) {
      ...
      let cf;
      if (
        Store.luckysheet_select_save[0].column_focus == Store.luckysheet_select_save[0].column[0]
      ) {
        cf = col_s;
      } else {
        cf = col_e;
  ...
  //右键菜单 复制按钮
  $('#luckysheet-copy-btn, #luckysheet-cols-copy-btn, #luckysheet-paste-btn-title').click(function(
    event,
  ) {
    $(this)
      .parent()
  ...
  //右键菜单 粘贴按钮
  $('#luckysheet-copy-paste, #luckysheet-cols-paste-btn, #luckysheet-paste-btn-title').click(
    function(event) {
  ...
  $('#luckysheet-icon-upload').click(function() {
    ...
    $('#luckysheet-excel-upload').click();
  });

  $('#luckysheet-excel-upload').click(function(e) {
    e.stopPropagation();
  });
  $('#luckysheet-excel-upload').on('change', function(e) {
    if (!checkProtectionAuthorityNormal(Store.currentSheetIndex, 'editObjects', false)) {
      return;
    }
    let file = e.currentTarget.files[0];
  ...
  $('#luckysheet-chart-rangeShow').on(
    ...
    function(event) {
      ...
      if ($id == 'luckysheet-chart-rangeShow-content') {
        ...
        let col_s =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.content.column[0];
        ...
        let col_s =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.rowtitle.column[0];
        ...
        let col_s =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.coltitle.column[0];
    ...
    function(event) {
      ...
      if ($id == 'luckysheet-chart-rangeShow-content') {
        ...
        let col_s =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.rowtitle.column[0];
        let col_e =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.rowtitle.column[1];
        ...
        let col_s =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.coltitle.column[0];
        let col_e =
          chart_json.rangeArray[0].column[0] + chart_json.rangeSplitArray.coltitle.column[1];
  ...
  $('#luckysheet-wa-editor,#luckysheet-icon-morebtn-div,.luckysheet-toolbar-button').click(function(
    e,
  ) {
