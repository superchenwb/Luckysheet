...
export const toolbarIdMap = {
  ...
  download: '#luckysheet-icon-download', // 'print'
};
...
export function createToolbarHtml() {
  ...
  const htmlMap = {
    ...
    upload: `<div class="luckysheet-toolbar-button-split-left luckysheet-toolbar-button luckysheet-inline-block"
        data-tips="${toolbar.upload}" id="luckysheet-icon-upload" role="button" style="user-select: none;">
            <div class="luckysheet-toolbar-button-outer-box luckysheet-inline-block"
            style="user-select: none;">
                <div class="luckysheet-toolbar-menu-button-inner-box luckysheet-inline-block"
                style="user-select: none;">
                    ...
                    style="user-select: none;">
                        <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                            <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-rotation-none iconfont luckysheet-iconfont-dingbuduiqi"
                            style="user-select: none;">
                                <input id="luckysheet-excel-upload" type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" style="display:none;"></input>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    download: `<div class="luckysheet-toolbar-select luckysheet-toolbar-menu-button luckysheet-inline-block" data-tips="${toolbar.download}"
        id="luckysheet-icon-download" role="button" style="user-select: none;">
            ...
            style="user-select: none;">
                ...
                style="user-select: none;">
                    <div class="luckysheet-icon luckysheet-inline-block " style="user-select: none;">
                        <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-autofilter iconfont luckysheet-iconfont-dibuduiqi"
                        style="user-select: none;">
                        </div>
                    </div>
                </div>
